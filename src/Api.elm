...
notifications global msg from limit =
    get global
        ("notifications?from=" ++ String.fromInt from ++ "&limit=" ++ String.fromInt limit)
        msg
        (D.map3 NotificationResult
            (D.field "end" D.bool)
            (D.field "unread" D.int)
            (D.field "notifications"
                (D.list
                    (D.map3 NotificationMessage
                        (D.field "time" D.int)
                        (D.field "read" D.bool)
