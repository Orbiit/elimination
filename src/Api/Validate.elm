...
username =
    Utils.makeRegex "^[a-zA-Z0-9_-]{3,20}$"


usernameLabel =
    "Only letters, digits, underscores, and hyphens are allowed. This cannot be changed later."
...
nameLabel =
    "Lets others be able to find and eliminate you, which makes the game fair."
...
passwordLabel =
    "Must be at least 6 characters long. We recommend using a memorable sentence, such as \"Do not use example passwords.\""
...
emailLabel =
    "For password reset forms. You can also turn on email notifications if you want."
